...
workspace = r"C:\Users\Louis\PycharmProjects\HTS-AT(Conda)\HTS-Audio-Transformer" # the folder of your code
dataset_path = r"C:\Users\Louis\PycharmProjects\HTS-AT(Conda)\HTS-Audio-Transformer\esc-50\audio_32k" # the dataset path
